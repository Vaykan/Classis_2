...
staticMaxHitPoints(hitPoints),
staticMaxStamina(stamina),
staticMaxStrength(strength),
staticMaxAgility(agility)
{}
...
void Person::getStats() {
    ...
    cout << "***********************\n***********************\n"
    << name << ": \n"
    << "HitPoints: " << hitPoints << " (Range: " << minHitPoints << " - " << maxHitPoints << ")\n"
    << "Stamina: " << stamina << " (Range: " << minStamina << " - " << maxStamina << ")\n"
    << "Strength: " << strength << " (Range: " << minStrength << " - " << maxStrength << ")\n"
    << "Agility: " << agility << " (Range: " << minAgility << " - " << maxAgility << ")\n"
    << "\n***********************\n***********************\n \n \n";


}

void Person::getBattleStats() {
    cout << "***********************\n***********************\n"
         << name << ": \n"
         << "HitPoints: " << hitPoints << "/" << staticMaxHitPoints << endl
         << "Stamina: " << stamina << "/" << staticMaxStamina << endl
         << "Strength: " << strength << "/" << staticMaxStrength << endl
         << "Agility: " << agility << "/" << staticMaxAgility << endl
         << "\n***********************\n***********************\n \n \n";
}
